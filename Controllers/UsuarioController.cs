    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public IEnumerable<UsuarioModel> Get()
        {
           List<UsuarioModel> usuarioModels= new List<UsuarioModel>();  
            ...
            usuarioModels.Add(new UsuarioModel() { Id = 1,Name = "Karine",  Email = "karinetrevisann@gmail.com"});
        ...
        {
            UsuarioModel usuario = new UsuarioModel() { Id = 1, Name = "Karine", Email = "karinetrevisann@gmail.com" };
